...
@Repository
public interface StorageRep extends CrudRepository<Storage, Integer>, SharedRepository<Storage, Integer> {

//    @Query(value = "SELECT t FROM #{#entityName} t " +
//            "WHERE t.codeDetail.code = :codeDetail " +
//            "ORDER BY t.availability ASC ")
//    List<ComponentsWarehouse> getStorageInfo(@Param("codeDetail") Integer codeStorage);
}
