...
public class ComponentsWarehouseReport extends ConfigReport {

    private final List<ComponentsWarehouse> data;

    public ComponentsWarehouseReport(String nameSheet, List<ComponentsWarehouse> data) {
        super(nameSheet != null ? nameSheet : "Cклад деталей", "ComponentsWarehouse.xls");
        this.data = data;
    }
    ...
    public boolean createReport() {
        try {
            ...
            for (int i = 0; i < data.size(); i++) {
                ...
                if (curRow.getCodeDetail() != null) {
                    codeDetail.setCellValue(curRow.getCodeDetail().getName());
                } else
                    codeDetail.setBlank();
            ...
            System.out.println("Ошибка в создании 1ого отчета");
            return false;
        }
    }
    ...
    private void setHeaderReport() {
        ...
        staticName2.setCellValue("Наименование детали");
